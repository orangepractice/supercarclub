...
<head>
    ...
    <title>Supercar Club!　McLaren</title>
                ...
                <div class="portfolio-items">
                    <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item1.jpg" height="737" width="971" alt="">
                            <div class="overlay">
                    ...
                    <div class="portfolio-item joomla bootstrap col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item2.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">F1</a></h3>
                                    <p>不明</p>
                    ...
                    <div class="portfolio-item bootstrap wordpress col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item3.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">MP4-12C</a></h3>
                                    <p>新車価格:2869万円</p>
                                </div> 
                            </div>
                        </div>        
                    ...
                    <div class="portfolio-item joomla wordpress apps col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item4.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">MP4-12Cスパイダー</a></h3>
                                    <p>新車価格:3085万円</p>
                                </div> 
                            </div>
                        </div>           
                    ...
                    <div class="portfolio-item joomla html bootstrap col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item5.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">675LT</a></h3>
                                    <p>新車価格:4353万円</p>
                                </div> 
                            </div>
                        </div>      
                    ...
                    <div class="portfolio-item wordpress html apps col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item6.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">650S</a></h3>
                                    <p>新車価格:3160万円</p>
                    ...
                    <div class="portfolio-item wordpress html col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item7.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">570S</a></h3>
                                    <p>新車価格:2556万円</p>
                    ...
                    <div class="portfolio-item wordpress html bootstrap col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php bloginfo( 'template_directory' ); ?>/images/McLaren/item8.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">SLRマクラーレン</a></h3>
                                    <p>新車価格:5985～11000万円</p>
                                </div> 
                            </div>
                        </div>          
                    </div><!--/.portfolio-item-->
